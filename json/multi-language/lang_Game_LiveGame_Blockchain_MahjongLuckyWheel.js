var arrLang = {
    'EN': {
      ...
      'gameDetail_p1':'Blockchain Mahjong Lucky Wheel uses Mahjong as the main theme, which is full of Chinese cultural element. 52 segments on the wheel are filled with "East Wind", "South Wind", "West Wind", "North Wind", "Red Dragon",  "Green Dragon" and "White Dragon". After betting, if the wheel stops at the designated area, the player will be rewarded up to 45:1 payout. It is easy to play and full of surprises!',
      'feature_1.1': 'High-end encryption,',
      'feature_1.2': 'double verification required',
      'feature_1_p': "Blockchain Mahjong Lucky Wheel's game results are encrypted with SHA-256 technology. The 'Published Serial Number' will be shown before result releases and it will be automatically verified to the 'Verified Serial Number' after result releases. Players can also verify the result on the third party independent platform. Double verification can ensure the fairness and justice of the game.",
      'feature_2.1': 'Delicate design with rotating details, ',
      'feature_2.2': 'creating a real-life perception',
      'feature_2_p': 'In order to get closer to the real-life game experience of the wheel of fortune, the animation is mixed with advanced 2D and 3D technologies to meticulously portray every detail of the wheel of fortune, such as rotation, deceleration, and stay. It makes players feel like playing in real life. When the game results are released, the "close-up" mode is used to clearly display the game results.',
      'feature_3.1': 'Overview on pot size and',
      'feature_3.2': 'game history at a glance',
      'feature_3_p': 'The game platform provides the game history of last 48 games. The pot size and total betting amount of "East Wind", "South Wind", "West Wind", "North Wind", "Red Dragon",  "Green Dragon" and "White Dragon" are shown in details. Players can grasp the hot trend of the game and formulate betting strategies in real time to win the game.',
    },
