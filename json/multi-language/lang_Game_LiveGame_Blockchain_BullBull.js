var arrLang = {
    ...
    'TC': {
      ...
      //
      'LiveGames':'真人遊戲',
      'gameDetail_p1': '運氣加上你的實力，這款需要戰術思維的牛牛遊戲，配上簡單的遊戲規則，絕對讓你愛不釋手！牛牛設有多個投注選項，「庄」與各「閒」家比較大小決定贏輸；玩家可以押注「翻倍」，贏取高達 5 倍的回報！',
      'feature_1.1': '高端加密',
      'feature_1.2': '雙重驗證',
      'feature_1_p': '區塊鏈炸金花的遊戲結果均使用SHA-256技術加密，而「驗證加密文」則提前公布。開出結果後，玩家更可第三方獨立平台生成加密文，「雙重驗證」可以確保遊戲百份百公平、公正。',
      'feature_2.1': '視覺的衝擊',
      'feature_2.2': '最強對比色',
      'feature_2_p': '設計師採用藍色和紅色作遊戲界面主色調，強烈的色彩配搭加上令人亢奮的音效，絕對讓你有眼前一亮的體驗。',
      'feature_3.1': '詳細的遊戲統計',
      'feature_3.2': '',
      'feature_3_p': '遊戲結果清晰顯示「庄」、「閒」在過去近20局和近100局開出的獲勝百分比及統計，玩家可以參考記錄，輕鬆地部署下一局。',
    },
    ...
    'SC': {
      ...
      //
      'LiveGames':'真人游戏',
      'gameDetail_p1': '运气加上你的实力，这款需要战术思维的牛牛游戏，配上简单的游戏规则，绝对让你爱不释手！牛牛设有多个投注选项，「庄」与各「闲」家比较大小决定赢输；玩家可以押注「翻倍」，赢取高达 5 倍的回报！',
      'feature_1.1': '高端加密',
      'feature_1.2': '双重验证',
      'feature_1_p': '区块链炸金花的游戏结果均使用SHA-256技术加密，而「验证加密文」则提前公布。开出结果後，玩家更可第三方独立平台生成加密文，「双重验证」可以确保游戏百份百公平丶公正。',
      'feature_2.1': '视觉的冲击',
      'feature_2.2': '最强对比色',
      'feature_2_p': '设计师采用蓝色和红色作游戏界面主色调，强烈的色彩配搭加上令人亢奋的音效，绝对让你有眼前一亮的体验。',
      'feature_3.1': '详细的游戏统计',
      'feature_3.2': '',
      'feature_3_p': '游戏结果清晰显示「庄」丶「闲」在过去近20局和近100局开出的获胜百分比及统计，玩家可以参考记录，轻松地部署下一局。',
    }
  };
