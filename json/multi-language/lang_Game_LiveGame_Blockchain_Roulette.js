var arrLang = {
    'EN': {
      ...
      'feature_2.1': 'Playing with Dual Betting Area &',
      'feature_2.2': 'Favorite Bet Combinations',
      'feature_2_p': 'Apart from traditional betting area, players can also enjoy Blockchain Roulette by betting in racetrack with the selection of "Tiers" and "Voisins". Meanwhile, players can set up their own betting combinations and place bets with one click. Just like playing in live casino, every player can enjoy exciting gaming experience by "throwing" bets on roulette table. ',
    ...
    'TC': {
      ...
      //
      'LiveGames':'真人遊戲',
      'gameDetail_p1': '本遊戲採用歐式單零輪盤，由1至36號(包括0號)共有37個數字，細緻打造多元化投注區：「大/小」、「單/雙」、「紅/黑」、「0-36」、「1-3組」及「1-3行」等，給玩家贏取最高35倍派彩，完美呈現地中海式的玩樂風情。',
      'feature_1.1': '高端加密技術',
      'feature_1.2': '拒絕任何竄改',
      ...
      'feature_3.1': '齊全路紙',
      'feature_3.2': '特配冷熱號碼',
      'feature_3_p': '本遊戲匯聚真人輪盤的各種元素，增加路紙及遊戲記錄種類，更特設「冷/熱」號碼，即時顯示過往250局最熱門及最冷門的號碼，讓玩家盡覽遊戲走勢，在冷與熱之間，找出自己的致勝之道。',
    },
    ...
    'SC': {
      ...
      //
      'LiveGames':'真人游戏',
      'gameDetail_p1': '本游戏采用欧式单零轮盘，由1至36号(包括0号)共有37个数字，细致打造多元化投注区：「大/小」、「单/双」、「红/黑」、「0-36」、「1-3组」及「1-3行」等，给玩家赢取最高35倍派彩，完美呈现地中海式的玩乐风情。',
      'feature_1.1': '高端加密技术',
      'feature_1.2': '拒绝任何窜改',
      ...
      'feature_3.1': '齐全路纸',
      'feature_3.2': '特配冷热号码',
      'feature_3_p': '本游戏汇聚真人轮盘的各种元素，增加路纸及游戏记录种类，更特设「冷/热」号码，即时显示过往250局最热门及最冷门的号码，让玩家尽览游戏走势，在冷与热之间，找出自己的致胜之道。',
    }
  };
