var arrLang = {
    ...
    'TC': {
      ...
      //
      'Lottery':'彩票',
      'gameDetail_p1': '北京賽車又名北京PK、北京PK10，是中國熱門彩票遊戲，主打玩法簡單且開獎時間快速，絕對能讓玩家頓時感受心跳加速。',
      'feature_1.1': '玩法簡單',
      'feature_1.2': '刺激滿分',
      'feature_1_p': '「北京賽車」遊戲規則簡單，是線上博弈遊戲佼佼者。玩家以猜中賽果排名、大小、單雙、下注總和值等投注方式贏取豐盛彩金。',
      'feature_2.1': '運籌帷幄',
      'feature_2.2': '',
      'feature_2_p': '玩家不需要為分析賽局結果而煩惱，打開簡單易明圖表，開獎記錄一目了然，輕而易舉地進行新一輪投注。',
      'feature_3.1': '主播互動',
      'feature_3.2': '直播開獎過程',
    ...
    'SC': {
      ...
      //
      'Lottery':'彩票',
      'gameDetail_p1': '北京赛车又名北京PK、北京PK10，是中国热门彩票游戏，主打玩法简单且开奖时间快速，绝对能让玩家顿时感受心跳加速。',
      'feature_1.1': '玩法简单',
      'feature_1.2': '刺激满分',
      'feature_1_p': '「北京赛车」游戏规则简单，是线上博弈游戏佼佼者。玩家以猜中赛果的排名、大小、单双、下注总和值等投注方式赢取丰盛彩金。',
      'feature_2.1': '运筹帷幄',
      'feature_2.2': '',
      'feature_2_p': '玩家不需要因分析赛局结果而烦恼，打开简单易明图表，开奖记录一目了然，轻而易举地进行新一轮投注。',
      'feature_3.1': '主播互动',
      'feature_3.2': '直播开奖过程',
